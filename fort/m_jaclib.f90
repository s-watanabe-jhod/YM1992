	...
	do it =1, kt0
		...
		do is = 1, ks0
			...
			do m = 1, ndd2
				...
				mu = m1 - int((m1-1)/(ms2-1))
				mv = m3 - int((m3-1)/(mt2-1))
...
subroutine DSITRNS
	...
	do i = 1, nbi
		...
		CALL TRANS(ds1(i,1),ds2(i,1), xx,yy, 1,-1)
		ds1(i,1) = xx
		ds2(i,1) = yy

		CALL TRANS(ds1(i,2),ds2(i,2), xx,yy, 1,-1)
		ds1(i,2) = xx
		ds2(i,2) = yy

		CALL TRANS(ds1(i,3),ds2(i,3), xx,yy, 1,-1)
		ds1(i,3) = xx
		ds2(i,3) = yy

		CALL TRANS(ds1(i,4),ds2(i,4), xx,yy, 1,-1)
		ds1(i,4) = xx
		ds2(i,4) = yy
...
return
end subroutine DSITRNS

!==========
subroutine OUTJC(idtyp,iu)
...
return
end subroutine OUTJC

!==========
subroutine VERDS(xs,ys)
...
subroutine SMITRNS
	...
	do i = 1, nbi
		...
		CALL TRANS(ds1(i,1),ds1(i,2), xx,yy, 1,-1)
		ds1(i,1) = xx
		ds1(i,2) = yy

		CALL TRANS(ds2(i,1),ds2(i,2), xx,yy, 1,-1)
		ds2(i,1) = xx
		ds2(i,2) = yy
