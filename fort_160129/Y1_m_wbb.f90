...
contains
!=========
subroutine WHERE1(xx,ix,px,xa,xb,ku0)
	...
	if(xx > xb .or. xx < xa) stop ' WARNING SPECIFIED POINT IS OUT OF REGION'
...
!==========
subroutine BSVALI(px,py,bsv,ndeg,norder2)

	use mod_bspline

	implicit none

	integer, intent(in) :: ndeg, norder2
