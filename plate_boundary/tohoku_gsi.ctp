 34.0    143.0   0      :ALAT0,ALNG0 ICORD
...
----------------------------------------------
 1                      : LS
./flt/gsi_pac.flt       : FLT(input; fault surface position)
./cof/tohoku_gsi.cof    : FCOF(LS) OR "PLANE FAULT" (output; B-splined fault surface) [FL1]
  70.00        0.0      :BPHI(LS),BDLT(LS)(in degree)
 34.00  143.00          :BLAT(LS),BLON(LS)
 800.0 400.0            :BLEN(LS),BWID(LS)(in km)
  16  8  3              : JU0(LS),JV0(LS),NDGF(LS)
 - - - - - - - - - - - - - - - - - - - - - - -
