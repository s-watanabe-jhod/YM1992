...
----------------------------------------------
 1                      : LS
./flt/block_rot_LM4.flt : FLT(input; fault surface position)
./cof/NE_gsi3+4.cof     : FCOF(LS) OR "PLANE FAULT" (output; B-splined fault surface) [FL1]
  40.00        0.0      :BPHI(LS),BDLT(LS)(in degree)
 34.19  134.79          :BLAT(LS),BLON(LS)
 120.0 100.0            :BLEN(LS),BWID(LS)(in km)
