 33.0    135.0   0      : ALAT0,ALNG0 ICORD
...
----------------------------------------------
 1                      : LS
./flt/gphs.flt          : FLT(input; fault surface position)
./cof/nankai_camp.cof   : FCOF(LS) OR "PLANE FAULT" (output; B-splined fault surface) [FL1]
  23.66        0.0      : BPHI(LS),BDLT(LS)(in degree)
 31.30  133.10          : BLAT(LS),BLON(LS)
 560.0 336.0            : BLEN(LS),BWID(LS)(in km)
  15  9  3              : JU0(LS),JV0(LS),NDGF(LS)
 - - - - - - - - - - - - - - - - - - - - - - -
