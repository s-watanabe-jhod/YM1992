...
----------------------------------------------
 1                      : LS
./flt/block_rot_LM.flt  : FLT(input; fault surface position)
./cof/NE_gsi3+1.cof     : FCOF(LS) OR "PLANE FAULT" (output; B-splined fault surface) [FL1]
  23.00        0.0      :BPHI(LS),BDLT(LS)(in degree)
 32.75  130.0           :BLAT(LS),BLON(LS)
1200.0 300.0            :BLEN(LS),BWID(LS)(in km)
