...
----------------------------------------------
 1                      : LS
./flt/block_rot_LM5.flt : FLT(input; fault surface position)
./cof/NE_gsi3+5.cof     : FCOF(LS) OR "PLANE FAULT" (output; B-splined fault surface) [FL1]
  20.00        0.0      :BPHI(LS),BDLT(LS)(in degree)
 35.72  136.13          :BLAT(LS),BLON(LS)
