 30.0    128.5   0      :ALAT0,ALNG0 ICORD
...
----------------------------------------------
 1                      : LS
./flt/block_rot_LM2.flt : FLT(input; fault surface position)
./cof/NE_gsi3+2.cof     : FCOF(LS) OR "PLANE FAULT" (output; B-splined fault surface) [FL1]
  67.00        0.0      :BPHI(LS),BDLT(LS)(in degree)
 30.00  128.50          :BLAT(LS),BLON(LS)
 400.0 100.0            :BLEN(LS),BWID(LS)(in km)
